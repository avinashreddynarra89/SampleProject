...
(function(undefined) {
	...
	globalScope = (typeof global !== 'undefined' && (typeof window === 'undefined' || window === global.window)) ? global : this, oldGlobalMoment, round = Math.round, hasOwnProperty = Object.prototype.hasOwnProperty, i,
	...
	extend(Locale.prototype, {
		...
		relativeTime : function(number, withoutSuffix, string, isFuture) {
			...
			return (typeof output === 'function') ? output(number, withoutSuffix, string, isFuture) : output.replace(/%d/i,
					number);
		},
			...
			moment.fn = Moment.prototype,
			{
				...
				calendar : function(time) {
					...
					var now = time || moment(), sod = makeAs(now, this).startOf('day'), diff = this.diff(sod, 'days', true), format = diff < -6 ? 'sameElse'
							: diff < -1 ? 'lastWeek' : diff < 0 ? 'lastDay' : diff < 1 ? 'sameDay' : diff < 2 ? 'nextDay'
	...
	extend(
			moment.duration.fn = Duration.prototype,
			{
				...
				valueOf : function() {
					return this._milliseconds + this._days * 864e5 + (this._months % 12) * 2592e6 + toInt(this._months / 12)
							* 31536e6;
				},
