      ...
      compile: function uiMaskCompilingFunction(){
        ...
        return function uiMaskLinkingFunction(scope, iElement, iAttrs, controller){
          ...
          function bindEventListeners(){
            ...
            ///iElement.bind('blur', blurHandler);   "blurhandler" clears out any invalid entry, which is not an optimal user experience, so remove the binding to it.
          ...
          function unbindEventListeners(){
            ...
            ///iElement.unbind('blur', blurHandler); "blurhandler" clears out any invalid entry, which is not an optimal user experience, so remove the binding to it.
          ...
          /*Currently unused, as it triggers a deletion of any invalid input value.  As this is not an optimal user experience, its usage has been commented-out.*/
          ...
          function eventHandler(e){
            ...
            if(iElement.prop("value") == '' || (iElement.prop("value") === iAttrs.placeholder)){
            	if((eventType == "click" || eventType == "focus") || (oldIEleVal != "dummy" && eventType == "input")){
            		var inputField = this;
            		setTimeout(function(){
            			setCaretPosition(inputField, 1);	
            		}, 250);
            		oldIEleVal = "dummy";
            		console.log("oldIEleVal:::"+oldIEleVal);
            	}
              	return false;
            }else{
            	
            	if(eventType == "input"){
            		oldIEleVal = iElement.prop("value");
            		var val = iElement.prop("value");
            		
            		oldIEleVal = val.replace(/[\-()x ]/g, "");
            		
            		
            		console.log("oldIEleVal:::"+oldIEleVal);
            		console.log("oldIEleVal Length:::"+oldIEleVal.length);
            		
            		if(oldIEleVal.length == 10) {
            			return false;
            		}
