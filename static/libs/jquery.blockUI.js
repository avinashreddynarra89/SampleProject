	...
	function setup($) {
		...
		function install(el, opts) {
			...
			if (msie || opts.forceIframe)
				lyr1 = $('<iframe class="blockUI" style="display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="'
			...
			if (opts.theme && full) {
				s = '<div class="blockUI ' + opts.blockMsgClass
						+ ' blockPage ui-dialog ui-widget ui-corner-all" style="display:none;position:fixed">';
				if (opts.title) {
				...
				s = '<div class="blockUI ' + opts.blockMsgClass
						+ ' blockElement ui-dialog ui-widget ui-corner-all" style="display:none;position:absolute">';
				if (opts.title) {
					s += '<div class="ui-widget-header ui-dialog-titlebar ui-corner-all blockTitle">' + (opts.title || '&nbsp;')
							+ '</div>';
				}
				...
				s = '<div class="blockUI ' + opts.blockMsgClass + ' blockElement" style="display:none;position:absolute"></div>';
			}
			lyr3 = $(s);
